---
name: "source-command-chefbar-new-skill"
description: "Create a new ChefBar Agent Skill under .agents/skills using skill-creator conventions, with a Codex discovery symlink."
---

# source-command-chefbar-new-skill

Use this skill when the user asks to run the migrated source command `chefbar-new-skill`.
...
- Codex discovery: symlink `.cursor/skills/<kebab-name>` → `../../.agents/skills/<kebab-name>`
- Subagent that executes it: `.cursor/agents/<kebab-name>.md` (Codex Task-formaat)
